...
public class RequireSwitch {
    public static void main(String[] ObengMCKennedy) {
        ...
        while (true) {
            ...
            if (name.equals("-1")) {
                ...
                // condoned=true;
                // }
                boolean condoned = (examScore == 25 && assessmentScore == 14)
                        || (examScore == 24 && assessmentScore == 15) && feesPaid == 100;
    ...
    private static int getResult(boolean condoned, boolean passedExam, boolean passedAssessment, boolean passedBoth,
            boolean fullpayment) {
        if (condoned) {
            return 0;
